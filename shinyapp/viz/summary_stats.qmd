...
summary_stats <- function(raw, schedule, tba_data, teams, pridge) {
    data <- raw |>
        ...
        summarise(
            ...
            `Auto Climb` = paste0(sum(auto_climb), "/", n()),
        ...
        select(
            ...
            Driver, `Solo Shot`, Died, Card, ACP)
}

mldf <- summary_stats(raw, schedule, tba_data, teams, pridge)
```